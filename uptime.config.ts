...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://nekoyo.ltd', label: '博客' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: '监测站',
      method: 'HEAD',
      target: 'https://status.nekoyo.ltd',
      statusPageLink: 'https://status.nekoyo.ltd',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '博客总入口（自动分流）',
      method: 'HEAD',
      target: 'https://nekoyo.ltd',
      statusPageLink: 'https://nekoyo.ltd/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      name: '网站',
      method: 'HEAD',
      target: 'https://pan.nekoyo.ltd',
      statusPageLink: 'https://pan.nekoyo.ltd',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '随机图片API）',
      method: 'HEAD',
      target: 'https://cdn2.nekoyo.ltd/img.php',
      statusPageLink: 'https://cdn2.nekoyo.ltd/img.php',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '主站',
      method: 'GET',
      target: 'http://120.26.132.25:8089',
      statusPageLink: 'https://nekoyo.ltd',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
